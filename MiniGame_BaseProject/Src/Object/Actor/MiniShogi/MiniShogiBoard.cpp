...
void MiniShogiBoard::Init(void)
{
	...
	board[0][4] = { PieceType::HISHA,   false,false };
	board[0][3] = { PieceType::KAKUGYO, false,false };
	board[0][2] = { PieceType::GIN, false,false };
	board[0][1] = { PieceType::KIN,   false,false };
	board[0][0] = { PieceType::OU,   false,false };

	board[1][0] = { PieceType::FU, false,false };

	// 下側（プレイヤー）

	board[3][4] = { PieceType::FU, true,false };

	board[4][4] = { PieceType::OU,   true,false };
	board[4][3] = { PieceType::KIN,   true,false };
	board[4][2] = { PieceType::GIN, true,false };
	board[4][1] = { PieceType::KAKUGYO, true,false };
	board[4][0] = { PieceType::HISHA,   true,false };
}
